...
This is a valid markdown file with a [relative link](./somefile.md).
EOF
...
test_runner relative_link_inside_of_root "Expecting success with valid root"
